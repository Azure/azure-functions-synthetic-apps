...
app.http('httpTriggerRouteParams', {
    methods: ['GET', 'POST'],
    route: 'httpTriggerModelV4Node18/httpTriggerRouteParams/{name}/{id}',
    authLevel: 'anonymous',
...
app.http('httpTriggerQuery', {
    ...
    route: 'httpTriggerModelV4Node18/httpTriggerQuery'
});
...
app.http('httpCookies', {
    ...
    authLevel: 'anonymous',
    handler: httpCookies,
    route: 'httpTriggerModelV4Node18/httpCookies'
});
...
app.http('helloWorldFunction', { // Use a valid function name
    ...
    authLevel: 'anonymous',
    handler: helloWorld,
    route: 'httpTriggerModelV4Node18/helloWorld'
});
...
app.http('invocationHooks', {
    ...
    route: 'httpTriggerModelV4Node18/invocationHooks'
});

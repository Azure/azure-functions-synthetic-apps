...
app.http('httpTriggerRouteParams', {
    methods: ['GET', 'POST'],
    route: 'httpTriggerModeV4Node20/httpTriggerRouteParams/{name}/{id}',
    authLevel: 'anonymous',
...
app.http('httpTriggerQuery', {
    ...
    route: 'httpTriggerModeV4Node20/httpTriggerQuery'
});
...
app.http('httpCookies', {
    ...
    authLevel: 'anonymous',
    handler: httpCookies,
    route: 'httpTriggerModeV4Node20/httpCookies'
});
...
app.http('helloWorldFunction', { // Use a valid function name
    ...
    authLevel: 'anonymous',
    handler: helloWorld,
    route: 'httpTriggerModeV4Node20/helloWorld'
});
...
app.http('invocationHooks', {
    ...
    route: 'httpTriggerModeV4Node20/invocationHooks'
});
